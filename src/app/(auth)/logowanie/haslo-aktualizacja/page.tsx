  ...
  if (searchParams.token) {
    ...
    return (
      <div className="flex min-h-screen w-full items-center justify-center">
        <Card className="max-sm:flex max-sm:h-screen max-sm:w-full max-sm:flex-col max-sm:items-center max-sm:justify-center max-sm:rounded-none max-sm:border-none sm:min-w-[370px] sm:max-w-[368px]">
          <CardHeader className="space-y-1">
            <CardTitle className="text-2xl">Zmiana hasła</CardTitle>
            <CardDescription>
              Wybierz i zatwierdź swoje nowe hasło
            </CardDescription>
          </CardHeader>
          <CardContent className="grid gap-2">
            ...
            />
            <Link
              aria-label="Anuluj zmianę hasła"
              href="/logowanie"
              className={buttonVariants({ variant: "outline" })}
            >
              <span className="sr-only">Anuluj zmianę hasła</span>
              Anuluj
            </Link>
          </CardContent>
        </Card>
    ...
    return (
      <div className="flex min-h-screen w-full items-center justify-center">
        <Card className="max-sm:flex max-sm:h-screen max-sm:w-full max-sm:flex-col max-sm:items-center max-sm:justify-center max-sm:rounded-none max-sm:border-none sm:min-w-[370px] sm:max-w-[368px]">
          <CardHeader>
            <CardTitle>Brak kodu resetującego hasło</CardTitle>
            <CardDescription>
              Wróć do strony logowania i spróbuj ponownie
            </CardDescription>
          </CardHeader>
