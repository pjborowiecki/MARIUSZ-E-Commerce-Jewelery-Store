      ...
      try {
        ...
        switch (message) {
          ...
          case "incorrect-provider":
            toast({
              title: "Email jest już przypisany do innego konta",
              description: "Być może założyłeś konto z Google lub Facebook?",
            })
            break
          case "unverified-email":
            toast({
              title: "Wszystko po kolei",
              description: "Zweryfikuj adres email by móc się zalogować",
            })
            break
